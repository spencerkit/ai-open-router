...
export const Modal: React.FC<ModalProps> = ({
  ...
  const modalClasses = [styles.modal, size !== "medium" && styles[size], className]
    .filter(Boolean)
    .join(" ")
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: Modal backdrop click is intentional.
