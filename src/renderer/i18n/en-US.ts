...
export const enUS = {
  ...
  settings: {
    ...
    remoteRulesUpload: "Upload Rules",
    remoteRulesUpdate: "Update Rules",
    remoteHint:
      "Upload pushes current groups/rules to remote git. Update pulls remote rules and overwrites local groups.",
    ...
    remoteUploadSuccess: "Rules uploaded to remote repository",
  ...
  logs: {
    ...
    statsRuleFilterLabel: "Rule",
    statsTimeFilterLabel: "Time Range",
    statsRuleAll: "All Rules",
    statsRuleSearchPlaceholder: "Search group or rule name",
  ...
  ruleForm: {
    ...
    quotaEnabledHint: "When enabled, remaining quota is shown on the rule card.",
    ...
    quotaUseRuleToken: "Use Rule Token for Auth",
    ...
    quotaUnitPath: "Unit Path",
    quotaTotalPath: "Total Path",
    quotaResetAtPath: "Reset Time Path",
    quotaLowThreshold: "Low Quota Threshold (%)",
    quotaLowThresholdHint: "Rule card shows low-quota state when percent is below this value.",
    quotaThresholdError: "Low threshold must be a number greater than 0",
