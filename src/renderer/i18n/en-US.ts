...
export const enUS = {
  ...
  settings: {
    ...
    exportModalHint: 'Copy full JSON to clipboard, or export it to a selected folder with an auto-generated file name.',
    ...
    importModalWarning: 'Import will overwrite all current groups and rules. Continue only if you are sure.',
