...
export const enUS = {
  ...
  agentManagement: {
    ...
    editSubtitle: "Edit agent source files directly and save them back to the config directory.",
    ...
    otherSourceChangesPending: "Other source files still have unsaved changes",
  ...
  ruleForm: {
    ...
    addModelPlaceholder: "e.g. gpt-4.1-mini",
    add: "Add Model",
  ...
  groupEditPage: {
    ...
    targetModelPlaceholder: "Target model",
