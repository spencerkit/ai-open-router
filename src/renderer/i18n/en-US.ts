...
export const enUS = {
  ...
  settings: {
    ...
    savePort: "Save Port",
    ocAuthTitle: "/oc Route Bearer Token",
    ocAuthHint:
      "Keeps the existing /oc/* bearer-token logic unchanged. This does not protect /api/* or /management.",
    ocAuthEnabled: "Require bearer token for /oc/*",
    ocAuthEnabledHint:
      "Uses the existing server.authEnabled + server.localBearerToken behavior exactly as before.",
    ocAuthToken: "Bearer Token",
    ocAuthTokenHint: "Sent by clients calling /oc/*.",
    ocAuthTokenPlaceholder: "Enter token for /oc/*",
    ocAuthTokenConfirm: "Confirm Token",
    ocAuthTokenConfirmPlaceholder: "Re-enter the bearer token",
    ocAuthValidationRequired: "Enter a bearer token before enabling /oc/* protection",
    ocAuthValidationMismatch: "The bearer tokens do not match",
    ocAuthSave: "Save /oc Protection",
    ocAuthSaveSuccess: "/oc route protection updated",
    remoteAdminTitle: "Remote Management Password",
    remoteAdminHint:
      "Protects remote /api/* requests and the /management experience. Local loopback access remains password-free.",
  ...
  toast: {
    ...
    providerModelTestSuccess: "Model test succeeded: {{provider}} returned {{model}}",
