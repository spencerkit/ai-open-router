...
const BILLING_TEMPLATE_CATALOG: BillingTemplate[] = [
  {
    ...
    sourceNote: "Official model page pricing per 1M text tokens.",
  ...
  },
  {
    ...
    sourceNote:
      "Official model exists, but the token pricing table does not expose pay-as-you-go per-1M pricing on the reviewed page.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "zhipu",
    ...
    sourceNote: "Official page states input 0.8 CNY / 1M and output 2 CNY / 1M.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "zhipu",
    ...
    sourceNote:
      "Official page lists a unified 5 CNY / 1M token price; apply it symmetrically to input/output.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "zhipu",
    ...
    sourceNote:
      "Official page lists a unified 1 CNY / 1M token price; apply it symmetrically to input/output.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "zhipu",
    ...
    sourceNote:
      "Official page lists a unified 0.5 CNY / 1M token price; apply it symmetrically to input/output.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "zhipu",
    ...
    sourceNote:
      "Official model overview lists GLM-5, but the reviewed docs did not expose directly verifiable per-1M API pricing.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "zhipu",
    ...
    sourceUrl: "https://docs.bigmodel.cn/cn/guide/start/model-overview",
    sourceNote:
      "Reserved official-family placeholder; do not guess prices until Zhipu publishes a directly verifiable per-1M API price.",
    verifiedAt: VERIFIED_AT,
  },
]
