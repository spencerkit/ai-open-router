...
const BILLING_TEMPLATE_CATALOG: BillingTemplate[] = [
  {
    ...
    modelId: "gpt-5.5",
    modelLabel: "GPT-5.5",
    searchAliases: ["gpt55", "gpt-5.5", "gpt 5.5"],
    currency: "USD",
    inputPricePerM: 5,
    outputPricePerM: 30,
  ...
  },
  {
    ...
    searchAliases: ["gpt53codex", "gpt-5.3-codex", "gpt 5.3 codex"],
    currency: "USD",
    inputPricePerM: 1.75,
    outputPricePerM: 14,
    cacheInputPricePerM: 0.175,
    cacheOutputPricePerM: 0,
    completeness: "partial",
    availability: "ready",
  ...
  },
  {
    ...
    modelId: "gpt-5.2",
    modelLabel: "GPT-5.2",
    searchAliases: ["gpt52", "gpt-5.2", "gpt 5.2"],
    currency: "USD",
    inputPricePerM: 1.75,
    outputPricePerM: 14,
    cacheInputPricePerM: 0.175,
  ...
  },
  {
    ...
    searchAliases: ["gpt5codex", "gpt-5-codex", "gpt 5 codex"],
    currency: "USD",
    inputPricePerM: 1.25,
    outputPricePerM: 10,
    cacheInputPricePerM: 0.125,
    cacheOutputPricePerM: 0,
    completeness: "partial",
    availability: "ready",
  ...
  },
  {
    ...
    searchAliases: ["gpt54mini", "gpt-5.4-mini", "gpt 5.4 mini"],
    currency: "USD",
    inputPricePerM: 0.75,
    outputPricePerM: 4.5,
  ...
  },
  {
    ...
    searchAliases: ["gpt54nano", "gpt-5.4-nano", "gpt 5.4 nano"],
    currency: "USD",
    inputPricePerM: 0.2,
    outputPricePerM: 1.25,
    cacheInputPricePerM: 0.02,
    cacheOutputPricePerM: 0,
    completeness: "partial",
    availability: "ready",
  ...
  },
  {
    ...
    searchAliases: ["opus47", "claude opus 4.7", "claude-opus-4.7"],
    currency: "USD",
    inputPricePerM: 5,
    outputPricePerM: 25,
    cacheInputPricePerM: 0.5,
    cacheOutputPricePerM: 6.25,
    completeness: "full",
    availability: "ready",
    sourceUrl: "https://www.anthropic.com/research/claude-opus-4-7",
    sourceNote:
      "Base input/output pricing and API model ID are from Anthropic's official Opus 4.7 release page; prompt cache hit/write values follow Anthropic's official global pricing multipliers.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "anthropic",
    ...
    sourceNote:
      "Base input/output pricing are from Anthropic's official Sonnet 4.6 announcement; prompt cache hit/write values follow Anthropic's official global pricing multipliers.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "anthropic",
    ...
    sourceNote:
      "Official legacy pricing entry retained for older Opus 4.1 search coverage; prompt cache hit/write values use Anthropic's published pricing table.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "anthropic",
    ...
    sourceNote:
      "Base input/output pricing and API model ID are from Anthropic's official Haiku 4.5 product page; prompt cache hit/write values follow Anthropic's official global pricing multipliers.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "anthropic",
    ...
    sourceNote:
      "Official Sonnet product page entry retained for older Sonnet 4.5 search coverage; prompt cache hit/write values follow Anthropic's official global pricing multipliers.",
    verifiedAt: VERIFIED_AT,
  },
  {
    vendorId: "minimax",
