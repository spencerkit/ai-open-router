    ...
    <div className={styles.logDetailPage}>
      <div className={styles.header}>
        <div className={styles.headerTop}>
          ...
          <Button variant="default" size="small" icon={RefreshCw} onClick={() => refreshLogs()} loading={loading}>
            {t('logs.refresh')}
          </Button>
        </div>
        <h2>{t('logs.detailTitle')}</h2>
        <p className={styles.subtitle}>{t('logs.traceIdLabel')}: {decodedTraceId}</p>
      </div>
        ...
        <>
          <div className={styles.metaGrid}>
            ...
            <div className={styles.metaItem}>
              ...
              <strong>{t('logs.requestStatus', { status: log.httpStatus ?? '---', state: getStatusText(log.status) })}</strong>
            </div>
            <div className={styles.metaItem}>
              <span>{t('logs.request')}</span>
              <strong>{log.method} {log.requestPath}</strong>
            </div>
            <div className={styles.metaItem}>
